...
<motion.form onSubmit={onSubmitHandler} className='flex flex-col min-h-[90vh] justify-center items-center'
    ...
    >      <div>
      <div className='relative'>
        ...
        <span style={{ backgroundColor: '#571275' }} 
        className={`absolute bottom-0 left-0 h-1 ${loading? 'w-full transition-all duration-[10s]': 'w-0'} `}/>
      </div>
    ...
    {!isImageLoaded && <div className='flex w-full max-w-xl bg-neutral-500 text-white text-sm p-0.5 mt-10 rounded-full'>
      <input onChange={e=> setInput(e.target.value)} value={input}
        type='text' placeholder='Describe what you want to generate' className='flex-1 bg-transparent outline-none ml-8 max-sm:w-20 grey-placeholder'/>
